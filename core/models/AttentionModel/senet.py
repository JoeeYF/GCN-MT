...
from core.utils.config import cam_sigma, cam_w, lse_r
from core.modules.attentions.foreground_attention import FABlock
...
class SENet(nn.Module):
    ...
    def __init__(self, block, layers, groups, reduction, dropout_p=0.2,
        ...
        # self.sigma = nn.Linear(512, num_classes)
...
if __name__ == '__main__':
    model = se_resnet50(num_classes=1000, pretrained=False)
    out, gcams_refined, out_pool = model(torch.ones((8,3,512,512)))
    print(out.shape)
    print(gcams_refined.shape)
